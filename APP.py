...
with left_column:
    # st.header('Variables')
    a = st.number_input("Lymphocyte Count(10^9/L)", min_value=0, max_value=1000, step=1)
    b = st.number_input("Neutrophil To Lymphocyte Ratio", min_value=0.0, max_value=1000.0, step=0.1)
    c = st.number_input("Monocytes Counted(10^12/L)", min_value=0.0, max_value=100.0, step=0.1)
    d = st.number_input("Platelet Count(10^9/L)", min_value=0.0, max_value=1000.0, step=0.1)
    e = st.number_input("Glucose(mmol/L)", min_value=0.0, max_value=1000.0, step=0.1)
